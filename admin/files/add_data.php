                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <span id = "test_name_error" class="error text-danger"></span>
                      </div>
                      <div class="form-group">
                        <label>Exam time (MINUTES)</label>
                        <input type="number" class="form-control" id = "time" name="time" placeholder="Exam time"/>
                        <span id = "time_error" class="error text-danger"></span>
                      </div>
                      <div class="form-group">
                        <label>Course</label>
